...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/bat.png", nme.NME_assets_bat_png);
			type.set ("assets/bat.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/caveback.png", nme.NME_assets_caveback_png);
			type.set ("assets/caveback.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/caveset.png", nme.NME_assets_caveset_png);
			type.set ("assets/caveset.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/edge.png", nme.NME_assets_edge_png);
			type.set ("assets/edge.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/gema.png", nme.NME_assets_gema_png);
			type.set ("assets/gema.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/interface.png", nme.NME_assets_interface_png);
			type.set ("assets/interface.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/mage.png", nme.NME_assets_mage_png);
			type.set ("assets/mage.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/mazeback.png", nme.NME_assets_mazeback_png);
			type.set ("assets/mazeback.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/mazeset.png", nme.NME_assets_mazeset_png);
			type.set ("assets/mazeset.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/menu.png", nme.NME_assets_menu_png);
			type.set ("assets/menu.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/mpbar.png", nme.NME_assets_mpbar_png);
			type.set ("assets/mpbar.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/particles.png", nme.NME_assets_particles_png);
			type.set ("assets/particles.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/wallback.png", nme.NME_assets_wallback_png);
			type.set ("assets/wallback.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/wallset.png", nme.NME_assets_wallset_png);
			type.set ("assets/wallset.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_bat_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_bullet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_caveback_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_caveset_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class NME_assets_edge_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_gema_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_haxeflixel_svg extends flash.utils.ByteArray { }
class NME_assets_interface_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_mage_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_mazeback_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_mazeset_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_menu_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_mpbar_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_particles_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_wallback_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_wallset_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
